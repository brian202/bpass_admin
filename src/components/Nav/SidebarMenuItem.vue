    ...
    >
      ...
      >
        ...
        <div
          v-if="itemHasChild"
          class="arrow"
          :class="[{ arrow_open: show }, { arrow_slot: $slots['dropdown-icon'] }]"
        >
      ...
      >
        ...
        >
          <div
            v-if="show"
            class="dropdown"
            :class="isMobileItem && 'dropdown_mobile-item'"
...
export default {
  ...
  computed: {
    ...
    itemLinkClass() {
      return [
        'link',
        !this.isMobileItem ? `link_level-${this.level}` : '',
        { 'link_mobile-item': this.isMobileItem },
        // eslint-disable-next-line prettier/prettier
        { 'link_hover': this.hover },
        // eslint-disable-next-line prettier/prettier
        { 'link_active': this.active },
        { 'link_exact-active': this.exactActive },
        // eslint-disable-next-line prettier/prettier
        { 'link_disabled': this.item.disabled },
        this.item.class,
      ];
    },
    isItemHidden() {
