<template>
  ...
  >
    ...
    <div class="scroll-wrapper">
      ...
      <div v-if="isCollapsed" class="mobile-item" :style="mobileItemStyle.item">
        <sidebar-menu-item
          v-if="mobileItem"
          :item="mobileItem"
          :is-mobile-item="true"
    ...
    <button
      v-if="!hideToggle"
      class="toggle-btn"
      :class="{ 'toggle-btn_slot': $slots['toggle-icon'] }"
      @click="onToggleClick"
    >
...
export default {
  ...
  methods: {
    ...
    setMobileItem({ item, itemEl }) {
      ...
      const positionTop = top - sidebarTop;
